registry_regex = r'^https://registry\.cdlib\.org/api/v1/(?P<col_or_repo>collection|repository)/(?P<id>\d*)/?'
repository_template = "https://registry.cdlib.org/api/v1/repository/{0}/"
repository_regex = r'^https://registry\.cdlib\.org/api/v1/repository/(?P<id>\d*)/?'
